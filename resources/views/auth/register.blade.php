                    ...
                    <div class="content">
                        <div class="columns">
                            <div class="column is-6 is-offset-3">
                                ...
                                <p class="is-size-4 is-size-6-mobile">Already registered? <a href="{{ route('login') }}">Login
                                        to your account</a></p>
                                ...
                                <form method="post" action="/register">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input @class(['input', 'is-danger' => $errors->has('name'), 'is-medium']) type="text" name="name"
