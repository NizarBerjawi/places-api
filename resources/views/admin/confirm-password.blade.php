    ...
    <form method="post" action="{{ route('password.confirm') }}">
        ...
        @if ($intended === route('admin.account.confirm', ['id' => request()->user()->id, 'action' => 'delete']))
            <article class="message is-danger">
                <div class="message-body">
                    Once you confirm your password, you can <span class="has-text-weight-bold">delete your account forever.</span>
                </div>
            </article>
        @endif
        ...
        @if ($intended === route('admin.security.index'))
            <article class="message is-info">
                <div class="message-body">
                    Once you confirm your password, you will be able to <span class="has-text-weight-bold">update your two-factor authentication settings.</span>
                </div>
            </article>
        @endif
