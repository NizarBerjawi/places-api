...
{
    /**
     * Display a location of a specific city.
     *
     * @OA\Get(
     *     tags={"Cities"},
     *     path="/cities/{geonameId}/location",
     *     summary="Returns the location of a specific city.",
     *     operationId="getCityLocation",
     *
    ...
    {
        if (! Place::byCities()->where('geoname_id', $geonameId)->exists()) {
