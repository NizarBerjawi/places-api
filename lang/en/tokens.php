...
return [
    ...
    */
    ...
    'regenerate' => 'If you\'ve lost or forgotten this token, you can regenerate it, but be aware that any scripts or applications using this token will need to be updated.<div class="has-text-weight-bold block">This action is irreversible!</div>',
